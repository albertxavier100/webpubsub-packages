...
public:
  std::unique_ptr<test_web_socket_base> create(std::string uri,
                                               std::string protocol_name) {
    return std::make_unique<test_web_socket_base>();
  }
};
static_assert(webpubsub::web_socket_factory_t<test_web_socket_factory,
